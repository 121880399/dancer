package vodplayerview.activity;
...
import vodplayerview.playlist.AlivcPlayListAdapter;
import vodplayerview.playlist.AlivcPlayListManager;
import vodplayerview.playlist.AlivcVideoInfo;
import vodplayerview.utils.Commen;
import vodplayerview.utils.ScreenUtils;
import vodplayerview.utils.VidStsUtil;
import vodplayerview.utils.download.DownloadDBHelper;
import vodplayerview.view.choice.AlivcShowMoreDialog;
import vodplayerview.view.control.ControlView;
import vodplayerview.view.download.AddDownloadView;
import vodplayerview.view.download.AlivcDialog;
import vodplayerview.view.download.AlivcDownloadMediaInfo;
import vodplayerview.view.download.DownloadChoiceDialog;
import vodplayerview.view.download.DownloadDataProvider;
import vodplayerview.view.download.DownloadView;
...
import vodplayerview.view.tipsview.ErrorInfo;
