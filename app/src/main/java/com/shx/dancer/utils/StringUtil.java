...
public class StringUtil {
     ...
     * 判断字符串是否是数字
     */
    public static boolean isNumber(@NonNull String value) {
     ...
     */
    @Nullable
    public static String getKibolitDivisionStr(@Nullable String originalNumStr, int scale) {
        try {
     ...
     */
    @Nullable
    public static String parseStringPattern2(@Nullable String text, int scale) {
    ...
    @Nullable
    public static Locale toLocale(@Nullable String localeStr) {
        if (localeStr == null)
            return null;
     ...
     */
    @NonNull
    public static String fillNullArgs(@Nullable String args) {
     ...
     * @return
     */
    public static boolean checkTime(@Nullable String time) {
        boolean flag = true;
     ...
     */
    @NonNull
    public static String getISOString(@NonNull String nativeString) {
     ...
     * @param scale
     */
    public static void autoTextPlay(@NonNull final TextView target, final float start,
     ...
     */
    @NonNull
    public static SpannableStringBuilder lightStr(@NonNull String str, @NonNull String lightStr) {
    ...
    @NonNull
    public static SpannableStringBuilder lightStr(@NonNull String str, @NonNull String lightStr, String color) {
        int fstart = str.indexOf(lightStr);
        int fend = fstart + lightStr.length();
        SpannableStringBuilder style = new SpannableStringBuilder(str);
     ...
     */
    @Nullable
    public static String zip(@Nullable String primStr) {
     ...
     */
    @Nullable
    public static String unzip(@Nullable String compressedStr) {
    ...
    public static String formatStr(@NonNull String formatStr, String str) {
     ...
     **/
    @NonNull
    public static String[] separateTime(@NonNull String time) {
     ...
     * 根据分隔符分割字符串
     */
    public static String[] splitStr(@NonNull String str, @NonNull String symbol) {
        String[] split;
