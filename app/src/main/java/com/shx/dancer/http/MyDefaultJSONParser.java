...
public class MyDefaultJSONParser extends DefaultJSONParser {
    public MyDefaultJSONParser(@NonNull String input, @NonNull ParserConfig config, int features) {
        super(input, config, features);
    }

    public MyDefaultJSONParser(@NonNull char[] input, int length, @NonNull ParserConfig globalInstance, int features) {
        super(input, length, globalInstance, features);
    }

    public MyDefaultJSONParser(@NonNull String text, @NonNull ParserConfig globalInstance) {
        super(text, globalInstance);
    }

    //@Override
    public final void parseArrayNew(@NonNull final Collection array) {
        parseArrayNew(array, null);
    }

    //@Override
    public final void parseArrayNew(@NonNull final Collection array, Object fieldName) {
    ...
    @Nullable
    @Override
    public Object parseObject(@NonNull final Map object) {
    ...
    @Nullable
    public final Object parseObjectNew(@NonNull final Map object, Object fieldName) {
    ...
    @Nullable
    public static Object myValueToString(@Nullable Object value) {
        if (value != null) {
            value = value + "";
        }
